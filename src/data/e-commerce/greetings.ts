...
export const appointmentSummaries: AppointmentSummary[] = [
  {
    id: 1,
    patient: { name: 'John Carter', avatar: users[1].avatar },
  ...
  {
    id: 2,
    patient: { name: 'Emily Watson', avatar: users[2].avatar },
  ...
  {
    id: 3,
    patient: { name: 'Michael Brown', avatar: users[3].avatar },
  ...
  {
    id: 4,
    patient: { name: 'Sophia Taylor', avatar: users[4].avatar },
  ...
  {
    id: 5,
    patient: { name: 'Daniel Wilson', avatar: users[5].avatar },
  ...
  {
    id: 6,
    patient: { name: 'Olivia Martin', avatar: users[6].avatar },
  ...
  {
    id: 7,
    patient: { name: 'James Anderson', avatar: users[7].avatar },
  ...
  {
    id: 8,
    patient: { name: 'Isabella Moore', avatar: users[8].avatar },
    doctors: [users[2], users[7], users[15]],
    fee: 100,
  ...
  {
    id: 9,
    patient: { name: 'William Thomas', avatar: users[9].avatar },
  ...
  {
    id: 10,
    patient: { name: 'Ava Jackson', avatar: users[10].avatar },
...
export const appointments: Appointment[] = [
  {
    ...
    fee: `$${appointmentSummaries[9].fee}`,
  ...
  },
  {
    ...
    fee: `$${appointmentSummaries[6].fee}`,
  ...
  },
  {
    ...
    fee: `$${appointmentSummaries[2].fee}`,
    statusIcon: 'material-symbols:pending-actions',
    status: 'warning',
  },
  {
    ...
    fee: `$${appointmentSummaries[3].fee}`,
  ...
  },
  {
    ...
    fee: `$${appointmentSummaries[4].fee}`,
    statusIcon: 'material-symbols:check-circle-outline',
    status: 'success',
  },
  {
    ...
    fee: `$${appointmentSummaries[5].fee}`,
  ...
  },
  {
    ...
    fee: `$${appointmentSummaries[1].fee}`,
    statusIcon: 'material-symbols:check-circle-outline',
    status: 'success',
  },
  {
    ...
    fee: `$${appointmentSummaries[7].fee}`,
    statusIcon: 'material-symbols:check-circle-outline',
    status: 'success',
  },
  {
    ...
    fee: `$${appointmentSummaries[8].fee}`,
    statusIcon: 'material-symbols:pending-actions',
    status: 'warning',
  },
  {
    ...
    fee: `$${appointmentSummaries[0].fee}`,
    statusIcon: 'material-symbols:event-available',
    status: 'primary',
  },
];

...
const getTime = (time: string, dayOffset = 0) =>
...
export const taskList: CalendarTask[] = [
  {
    id: '6',
    title: 'Kickoff',
    ...
    allDay: false,
    description: 'Discuss goals and targets.',
    selectedList: 'work',
    repeated: 'weekly',
  },
  // {
...
export const appointments: CalendarEvent[] = [
  {
    id: '1',
    title: 'Boot Camp',
...
export const categoryColorMap: Record<string, PaletteColorKey> = {
  meeting: 'primary',

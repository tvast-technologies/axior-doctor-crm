...
export const allActivities: AllActivitiesData[] = [
  {
    id: 1,
    date: dayjs().subtract(2, 'hour').subtract(15, 'minute').toISOString(),
    activities: [
      {
        id: 1,
        type: 'booking',
        title: 'Appointment booking request submitted',
        color: 'primary',
        user: 'Amit Sharma',
        icon: 'material-symbols:event-available',
        assignment: 'Dr. Anjali Mehta',
        timeStamp: dayjs().format(),
      },
      {
        id: 2,
        type: 'call',
        title: 'Call with clinic for appointment confirmation',
        color: 'info',
        user: 'Clinic Support',
        icon: 'material-symbols:phone-in-talk-outline-rounded',
        assignment: 'Amit Sharma',
        timeStamp: dayjs().format(),
      },
      {
        id: 3,
        type: 'mail',
        title: 'Appointment confirmation message sent',
        color: 'success',
        user: 'Clinic System',
      ...
      },
      {
        id: 4,
        type: 'note',
        title: 'Patient added symptoms note before consultation',
        color: 'warning',
        user: 'Amit Sharma',
  ...
  {
    id: 2,
    date: dayjs().subtract(1, 'day').subtract(3, 'hour').toISOString(),
    activities: [
      {
        id: 5,
        type: 'meeting',
      ...
      },
      {
        id: 6,
        type: 'attachment',
        title: 'Prescription uploaded to patient portal',
        color: 'primary',
        user: 'Dr. Pooja Iyer',
      ...
      },
      {
        id: 7,
        type: 'mail',
        title: 'Follow-up instructions shared via WhatsApp',
        color: 'info',
        user: 'Clinic System',
        icon: 'material-symbols:outgoing-mail-outline-rounded',
        assignment: 'Amit Sharma',
  ...
  // {
  //   id: 3,
  //   date: dayjs().subtract(3, 'day').subtract(4, 'hour').toISOString(),
  //   activities: [
  //     {
  //       id: 8,
  //       type: 'task',

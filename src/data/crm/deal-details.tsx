...
export const allActivities: AllActivitiesData[] = [
  {
    ...
    activities: [
      ...
      },
      {
        id: 3,
        type: 'mail',
        title: 'Appointment confirmation email sent',
        color: 'success',
        user: 'Clinic System',
      ...
      },
      {
        id: 4,
        type: 'note',
        title: 'Patient added symptoms note before visit',
        color: 'warning',
        user: 'John Carter',
  ...
  },
  {
    ...
    activities: [
      ...
      },
      {
        id: 7,
        type: 'mail',
        title: 'Follow-up instructions sent via email',
        color: 'info',
        user: 'Clinic System',
        icon: 'material-symbols:outgoing-mail-outline-rounded',
        assignment: 'Emily Watson',

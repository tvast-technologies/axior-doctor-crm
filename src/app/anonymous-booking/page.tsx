...
import { Box, Button, Chip, Container, Dialog, Stack, TextField, Typography } from '@mui/material';
...
const BookingPage = () => {
  ...
  return (
    <>
      ...
      >
        <Container>
          <Stack spacing={2} alignItems="center" textAlign="center" flexDirection={'column'}>
            <Stack>
            ...
            <Typography maxWidth={500} sx={{ opacity: 0.9 }}>
              Choose a date, pick a time slot, and confirm your appointment in seconds.
            </Typography>
          </Stack>
        </Container>
      </Box>
